...
enum {
    ...
    TD_RCTLALT, // ctrl, alt
    TD_MODVORARK_SHIFT, //mo to _pdovark on press, normal shift on hold
};
...
void td_fn_shift_layer_toggle_on(tap_dance_state_t *state, void *user_data)
{
...
//      see above. AT = @, circumflex below = ^
    ...
    [_SHIFTED_PDVORAK] = LAYOUT_5x7(
        ...
        KC_TRNS,         KC_TRNS,             LSFT(KC_LEFT),   LSFT(KC_RIGHT),
                                                                          LSFT(KC_BACKSPACE), LSFT(KC_DELETE),
                                                                          LSFT(KC_LCTL),      LSFT(KC_LALT),
        ...
        LSFT(KC_GRAVE),      LSFT(KC_D),  LSFT(KC_H),  LSFT(KC_T),    LSFT(KC_N),  LSFT(KC_S),  LSFT(KC_MINUS),
                  ...
                  LSFT(KC_ENTER),      LSFT(KC_SPACE),
                  LSFT(KC_LGUI),       LSFT(KC_RCTL),
    ...
    [_FN] = LAYOUT_5x7(
        ...
        _______,   WIN_SS,      KC_CALC,     KC_MYCM,
                                    ...
                                    _______, _______,
        // right hand
               KC_NUM_LOCK,          KC_F6,           KC_F7,     KC_F8,     KC_F9,      KC_F10,       KC_F11,
               KC_SCROLL_LOCK,       KC_KP_ASTERISK,  KC_KP_7,   KC_KP_8,   KC_KP_9,    KC_KP_MINUS,  KC_F12,
